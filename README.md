Esta API permite consultar as parcelas do programa Bolsa Família disponíveis para os beneficiários, com base no município e no período desejado (mês/ano).
